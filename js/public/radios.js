var SingleTextPage = TemplateManagerPage.extend("radios",
{
          ...
          if ( str.source != undefined  ) {
              for (var i = 0; i < str.source.length; i++) {
                  if (str.source[i]["radio_check"] == true)
                      this.html += "<input name = " + str.condition.text_name + " type = \'radio\'"+" ng-model=" + str.condition.text_dbname+" " + "checked  "  + "ng-checked=\'true\' " + " ng-value = " + str.source[i]["radio_name"] + " "+"\/> " + str.source[i]["radio_name"];
                  else
                      this.html += "<input name = " + str.condition.text_name + " type = \'radio\'"+" ng-model=" + str.condition.text_dbname+" "   + " ng-value = " + str.source[i]["radio_name"] + " "+"\/> " + str.source[i]["radio_name"];
                  //如果是横排
              ...
              this.html2 = ""
              this.html2 = '{|-<span  bositype = "radios" bosiplugins="radios" title="'+str.condition.text_name+'"  name= "' + str.condition.text_name  + '" ng-model="' + str.condition.text_dbname + '">';
